...
<CardGroup cols={2}>
  ...
  <Card title="Audit trail" icon="link" href="/core/audit-trail">
    Explore hash-chained audit logs and SIEM integration
  </Card>
  <Card title="Project policies" icon="folder" href="/guides/project-policies">
    Commit project-specific rules to your repo for team-shared security
  </Card>
  <Card title="Dashboard" icon="display" href="/core/dashboard">
