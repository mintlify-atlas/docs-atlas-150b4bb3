...
<Steps>
  <Step title="Create a custom CI policy">
    ```bash
  ...
  <Step title="Edit to allow specific operations">
    ```yaml
...
- [Native Ask Prompt](/guides/native-ask) — interactive approval for local development
- [Wazuh Integration](/guides/wazuh-integration) — SIEM integration for CI audit trails
