...
description: Monitor AI agent activity and trigger SIEM alerts when Rampart blocks dangerous operations.
---
...
<Steps>
  <Step title="Configure Wazuh Agent to Monitor Audit Files">
