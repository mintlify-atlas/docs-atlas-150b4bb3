---
title: Threat model
description: Security model, what Rampart protects against and limitations
---
...
<Warning>
Rampart is one layer in defense-in-depth, not a replacement for OS hardening, network segmentation, or access control.
</Warning>
...
The two-layer approach (pattern matching + LLM classification) significantly reduces the obfuscation surface. v0.6.9 closed 10 specific bypass vectors identified in a security audit.
...
<Warning>
Monkey-patching is fragile but functional. It closes a real security gap today while proper upstream hook support is developed.
</Warning>
...
If you've found a vulnerability not covered here, please email [rampartsec@pm.me](mailto:rampartsec@pm.me). We'll acknowledge within 48 hours and work with you on coordinated disclosure.
